...
def convert_from_original_zero123_ckpt(
    ...
    feature_extractor = CLIPImageProcessor.from_pretrained('lambdalabs/sd-image-variations-diffusers', subfolder='feature_extractor')
    image_encoder = CLIPVisionModelWithProjection.from_pretrained('lambdalabs/sd-image-variations-diffusers', subfolder='image_encoder') 
